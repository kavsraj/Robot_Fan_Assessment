...
import org.robot.fan.util.FileOperations;
import org.robot.fan.util.PropertyManager;
...
public class ReportListener implements ConcurrentEventListener {
  ...
  private void runStarted(TestRunStarted event) {
    ...
    try {
      ...
      throw new RuntimeException("Unable to load extent config");
    }
